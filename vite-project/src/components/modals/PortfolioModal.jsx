...
export default function PortfolioModal({ isOpen, onClose, onEdit }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Mening profilim">
      <div className="p-5">
        {/* Avatar + name */}
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900 dark:text-white">{profile.phone || "Ko'rsatilmagan"}</p>
            </div>
          </div>
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <div>
              <p className="text-xs text-gray-400">Tug'ilgan kun</p>
              <p className="text-sm text-gray-900 dark:text-white">{profile.birthday || "Ko'rsatilmagan"}</p>
            </div>
          </div>
        </div>
        ...
        >
          <i className="fas fa-edit mr-2" />Tahrirlash
        </button>
      </div>
    </Modal>
  );
